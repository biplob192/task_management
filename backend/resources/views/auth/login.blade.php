                        ...
                        <div class="w-100">
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    @endif --}}
                                    <form class="mt-4 pt-2" method="POST" action="{{ route('auth.login') }}">
                                        @csrf
                                        <div class="mb-3">
                                    ...
                                    <div class="social-auth-links text-center mt-2 mb-3">
                                        <a href="{{ route('auth.google') }}" class="btn btn-block btn-danger w-100 waves-effect waves-light">
                                            {{-- <i class="fab fa-google-plus mr-2"></i> Sign in using Google --}}
                                            <i class="mdi mdi-google mr-2"></i> Sign in using Google
                                        </a>
                                    </div>
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="text-muted mb-0">Don't have an account ? <a href="{{ route('auth.register') }}" class="text-primary fw-semibold"> Signup now </a> </p>
                                    </div>
                                </div>
                                <div class="mt-4 mt-md-5 text-center">
                                    Design & Develop by <a href="https://biplob192.github.io/" target="_blank" class="text-decoration-underline">MD BIPLOB MIA</a>
                                </div>
                            </div>
                        </div>
                    </div>
